...
whether expressed through the ORM class or as SQL text; and given the vocabulary repository with a
...
- THEN none contains an `INSERT`, `UPDATE` or `DELETE` targeting `manual_correction`
