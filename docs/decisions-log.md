...
| 2026-07-16 | Engineering Playbook adoption deferred | Process | `openspec/changes/docs-methodology-overhaul/proposal.md §4` | Playbooks written before real development cycles are speculative and drift from practice immediately | Revisit trigger: "After first vertical slice ships end-to-end (upload a .txt file and view a lemma list with frequency)" |
| 2026-07-16 | Documentation language policy — methodology EN, product-facing ES | Documentation | ADR-0010 (pending Wave 2, Slice C) | Match Synaptiq/Wellforge convention; methodology artifacts consumed by agents benefit from EN; product-facing artifacts already established in ES | Bilingual repo with clear per-file language policy; ADRs and architecture docs in EN; constitution, product-vision, glossary in ES |
| 2026-07-16 | docs-methodology-overhaul SDD cycle executed | Meta | [`openspec/changes/docs-methodology-overhaul/`](../openspec/changes/docs-methodology-overhaul/) | Lift the methodology surface (ADRs, architecture baseline, glossary, traceability, DoD, constitution amendment) to Synaptiq/Wellforge level | 5 slices A..E; ~1700–1830 lines aggregate; Wave 1 ADRs (0002–0006) land in Slice B; Wave 2 (0007–0010) in Slice C |

---

> **Note**: Wave 2 entries (ADR-0007..0010, SPEC-001 DEC-001..006, glossary decision, constitution amendment v2.0.0, and further methodology decisions) will be appended in Slice C.
