...
`openspec/changes/archive/2026-08-26-lemmatization-pos/specs/003-lemmatization-pos/spec.md`. `003-lemmatization-pos` has
...
`openspec/changes/archive/2026-08-26-lemmatization-pos/design.md` §P1 and `docs/traceability-matrix.md` SHALL NOT contain
