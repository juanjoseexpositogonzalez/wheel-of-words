...
| 2026-08-03 | SPEC-001 project foundation archived | Architecture | [`openspec/archive/2026-08-03-project-foundation-bootstrap/`](../openspec/archive/2026-08-03-project-foundation-bootstrap/) | Close the executable FastAPI, React, SQLite/Alembic, E2E, CI, quality, documentation, and traceability foundation before product-domain work | Future features build on the tested health contract and must keep language/domain logic out of the frontend |
