...
| 2026-08-02 | SPEC-001 project foundation closed out | Architecture | [`openspec/changes/project-foundation-bootstrap/`](../openspec/changes/project-foundation-bootstrap/) | Deliver the documented local FastAPI, React, SQLite/Alembic, E2E, CI, and quality baseline before product-domain work | Future features build on the tested health contract and must keep language/domain logic out of the frontend |
